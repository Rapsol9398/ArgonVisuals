...
import com.rapsol.module.setting.MinMaxSetting;
...
public final class MinMaxSlider extends RenderableSetting {
    ...
    public void render(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        TextRenderer.text(str, context, (int) ((parentX() + 5) / scalable), (int) (((parentY() + parentOffset() + offset) + 9) / scalable), new Color(245, 245, 245, 255).getRGB());
        matrices.popMatrix();
